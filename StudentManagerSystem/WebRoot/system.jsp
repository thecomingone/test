    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						...
						{"menuid":"2","icon":"","menuname":"班级信息管理",
							"menus":[
									{"menuid":"21","menuname":"班级列表","icon":"icon-house","url":"ClazzServlet?method=toClazzListView"}
								]
						},
...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="float:right; padding-right:20px;" class="head"><span style="color:red; font-weight:bold;">${user.adminName}&nbsp;</span>您好&nbsp;&nbsp;&nbsp;<a href="InvalidateServlet" id="loginOut">安全退出</a></span>
        <span style="padding-left:10px; font-size: 16px; ">学生信息管理系统</span>
    </div>
    <div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
        <div class="footer">Copyright &copy; By 【喻坤】</div>
    </div>
    <div region="west" hide="true" split="true" title="导航菜单" style="width:180px;" id="west" >
	  <!--  easyui折叠面板 -->
	   <div id="nav" class="easyui-accordion" fit="true" border="false" selected="false">
		<!--  导航内容 -->
	   </div>	
    </div>
